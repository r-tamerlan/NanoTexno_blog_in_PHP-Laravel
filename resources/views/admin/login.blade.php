...
<head>
    ...
    <link href="{{ asset('admin_app-assetc/assets/css/authentication/form-2.css') }}" rel="stylesheet" type="text/css" />
...
<body class="form" style="background: rgb(2,0,36);
                    ...
                    <form class="text-left" action="{{ route('admin.login') }}" method="post">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="username" name="email" type="text" class="form-control" placeholder="example@gmail.com">
                            </div>
...
<script src="{{ asset('admin_app-assetc/assets/js/authentication/form-2.js') }}"></script>
